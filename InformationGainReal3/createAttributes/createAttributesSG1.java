...
public class createAttributesSG1{

public static Instances createAttributesSG1(Hashtable Users) 
{
	  /* define and create set of instances for input data */
    	...
    	//              numFriendsS, like1, like2, like3, classvalue, auth, mod
          ...
          while ( en1.hasMoreElements() ){
        		...
        		att0 = " "; att1 = nw.getnidsflags(1); att2 = nw.getnidsflags(2); 
        		att3 = " "; att4 = nw.getnidsflags(4);
        		
        		// metric 1
        		att5  = " ";  att6  = nw.getcnd(1);  att7  = nw.getcnd(2);  
        		att8  = " ";  att9  = nw.getcnd(4);
        		
        		// metric 2
        		att10 = " "; att11 = nw.getcnsand(1); att12 = nw.getcnsand(2); 
        		att13 = " "; att14 = nw.getcnsand(4);
        		
        		// metric 3
        		att15 = " ";  att16 = nw.getaad(1); att17 = nw.getaad(2);  
        		att18 = " ";  att19 = nw.getaad(4);
