...
public class createAttributesGALL{

public static Instances createAttributesGALL(Hashtable Users) 
{
	  /* define and create set of instances for input data */
    	...
    	//              numFriendsS, like1, like2, like3, classvalue, auth, mod
          ...
          while ( en1.hasMoreElements() ){
        		...
        		att0 = nw.getnidsflags(0); att1 = nw.getnidsflags(1); att2 = nw.getnidsflags(2); 
        		att3 = nw.getnidsflags(3); att4 = nw.getnidsflags(4);
        		
        		// metric 1
        		att5  = nw.getcnd(0);  att6  = nw.getcnd(1);  att7  = nw.getcnd(2);  
        		att8  = nw.getcnd(3);  att9  = nw.getcnd(4);
        		
        		// metric 2
        		att10 = nw.getcnsand(0); att11 = nw.getcnsand(1); att12 = nw.getcnsand(2); 
        		att13 = nw.getcnsand(3); att14 = nw.getcnsand(4);
        		
        		// metric 3
        		att15 = nw.getaad(0);  att16 = nw.getaad(1); att17 = nw.getaad(2);  
        		att18 = nw.getaad(3);  att19 = nw.getaad(4);
